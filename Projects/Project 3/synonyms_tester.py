...
import socket, threading, json, contextlib, io, time, sys, re
from random import *

synonyms = __import__("synonyms") #put your filename here 
            ...
            while (True or cnt > 1000):
                ...
                try:
                    ...
                    try:
                        ...
                        print("Something went wrong. Try running it again without changing anything, it might just fix itself. (Trust me, we do this all the time.)")
                        sys.exit(1)
